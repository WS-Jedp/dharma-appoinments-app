  ...
  return (
    <ModalContainer>
      ...
      >
        ...
        <p>
          If you delete the user you will not be able to recover it. This action is irreversible.
        </p>
        ...
        <div className="w-full flex flex-row items-center justify-center">
          {loading ? (
            ...
            <div className="w-full h-full flex flex-row items-center justify-center my-3">
              <button
                className="border border-red-600 text-red-600 rounded-full text-md px-6 py-2 hover:text-white hover:bg-red-600 w-full mx-2"
                onClick={onDelete}
              >
                Yes
              </button>
              <button
                className="border border-gray-600 text-gray-600 rounded-full text-md px-6 py-2 hover:text-white hover:bg-gray-700 w-full mx-2"
                onClick={onCancel}
              >
                No
              </button>
